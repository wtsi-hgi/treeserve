#ifndef SRC_TREESERVE_ROUTER_HPP_
#define SRC_TREESERVE_ROUTER_HPP_
...
class TreeserveRouter : public proxygen::RequestHandlerFactory {
 public:
...
#endif  // SRC_TREESERVE_ROUTER_HPP_
